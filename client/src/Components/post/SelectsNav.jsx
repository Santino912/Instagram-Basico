...
export default function SelectsNav({
  handleLike,
  likeStatus,
  handleShow,
  handleSave,
  ...
  return (
    <>
      <div className={style.selectsDiv}>
        ...
        <button className={style.comentButton} onClick={handleModal}>
          <svg
            aria-label="Comentar"
            height="24"
            role="img"
        ...
        <button className={style.shareButton} onClick={handleModal}>
          <svg
        ...
        <div className={style.navbarImage}>
          <div className={style.imageRoll}></div>
        </div>

        <button className={style.saveBar} onClick={handleSave}>
          {saveStatus ? (
            <svg
              aria-label="Eliminar"
              color="black"
